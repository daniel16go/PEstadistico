...
{
    public class ImportEntity : IEntity
    {
        [Key]
        ...
        public ICollection<ImportDetailEntity> ImportDetails { get; set; }

        public ICollection<ContainerEntity> Containers { get; set; }

        public ICollection<CommImportEntity> CommImports { get; set; }

        public ICollection<ImportFileEntity> ImportFiles { get; set; }
