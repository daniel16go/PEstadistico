#pragma checksum "C:\Users\daniel.gomez\Documents\MEGA\Trabajos Externos\Estadistico\Productivo\Productivo.Web\Views\Template\Utilities\Flexbox.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4be44a587987ee4b6a9712235d18525c54ee3e45"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Template_Utilities_Flexbox), @"mvc.1.0.view", @"/Views/Template/Utilities/Flexbox.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4be44a587987ee4b6a9712235d18525c54ee3e45", @"/Views/Template/Utilities/Flexbox.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3cb4063a92509016e34f5fa38813b43f5c4dd013", @"/Views/_ViewImports.cshtml")]
    public class Views_Template_Utilities_Flexbox : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\daniel.gomez\Documents\MEGA\Trabajos Externos\Estadistico\Productivo\Productivo.Web\Views\Template\Utilities\Flexbox.cshtml"
...
#nullable disable
            DefineSection("HeadBlock", async() => {
                WriteLiteral("\r\n");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "4be44a587987ee4b6a9712235d18525c54ee3e455726", async() => {
                }
                );
	...
	<div class=""col-lg-12"">
		<div class=""alert alert-warning"">
            ...
            BeginWriteAttribute("href", " href=\"", 770, "\"", 836, 3);
            WriteAttributeValue("", 777, "https://getbootstrap.com/docs/", 777, 30, true);
#nullable restore
#line 16 "C:\Users\daniel.gomez\Documents\MEGA\Trabajos Externos\Estadistico\Productivo\Productivo.Web\Views\Template\Utilities\Flexbox.cshtml"
WriteAttributeValue("", 807, ViewBag.Bs4v, 807, 13, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 820, "/utilities/flex/", 820, 16, true);
            EndWriteAttribute();
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				<h4 class=""mb-g"">
					...
					<small>
						Set the direct");
            WriteLiteral(@"ion of flex items in a flex container with direction utilities. In most cases you can omit the horizontal class here as the browser default is row. However, you may encounter situations where you needed to explicitly set this value (like responsive layouts).
					</small>
				</h4>
				<h5 class=""frame-heading"">
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				<h4 class=""mb-g"">
					...
					<small>
						<code>justify-content</code> utilities on flexbox containers to change the alignment of flex items on the main axis (the x-axis to st");
            WriteLiteral(@"art, y-axis if <code>flex-direction: column</code>). Choose from <code>start</code> (browser default), <code>end</code>, <code>center</code>, <code>between</code>, or <code>around</code>.
					</small>
				</h4>
				<div class=""frame-wrap"">
					  ...
					  <div class=""d-fle");
            WriteLiteral(@"x justify-content-between bd-highlight mb-3"">
					    <div class=""p-2 bd-highlight"">Flex item</div>
					    <div class=""p-2 bd-highlight"">Flex item</div>
					    <div class=""p-2 bd-highlight"">Flex item</div>
					  </div>
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				...
				<h5 class=""frame-heading"">
					 Choose from <code>start</code>, <code>end</code>, <code>center</code>, <code>baseline</code>, or <code>stretch</code");
            WriteLiteral(@"> (browser default).
				</h5>
				<div class=""frame-wrap"">
					  ...
					  <div class=""d-flex align-items-baseline bd-highlight mb-3"" style=""height: 100px"">
					    <div class=""p-2 bd-highlight"">Flex item</div>
					 ");
            WriteLiteral(@"   <div class=""p-2 bd-highlight"">Flex item</div>
					    <div class=""p-2 bd-highlight"">Flex item</div>
					  </div>
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				...
				<h5 class=""frame-heading"">
					 Choose from the same options as <code>align-items: start</code>, <code>end</code>, <code>center</code>, <code>baseline</code>, or <code>");
            WriteLiteral(@"stretch</code> (browser default).
				</h5>
				<div class=""frame-wrap"">
					...
					<div class=""d-flex bd-highlight mb-3"" style=""height: 100px"">
					   <div class=""p-2 bd-highlight"">Flex item</div>
					   <div clas");
            WriteLiteral(@"s=""align-self-baseline p-2 bd-highlight"">Aligned flex item</div>
					   <div class=""p-2 bd-highlight"">Flex item</div>
					</div>
			...
			<div class=""card-body"">
				...
				<div class=""frame-wrap"">
					<div class=""d-flex bd-highlight"">
					  ...
					  <div class=""p-2 flex-fill bd-highlight"">Flex item</d");
            WriteLiteral(@"iv>
			...
			<div class=""card-body"">
				...
				<div class=""frame-wrap"">
					<div class=""d-flex bd-highlight"">
					  ...
					  <div class=""p-2 bd-highlight"">Flex item</div>
					  <div class=""p-2 bd-highlight"">Third flex item</di");
            WriteLiteral(@"v>
					</div>
				</div>
				<h5 class=""frame-heading"">
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				<h4 class=""mb-g"">
					...
					<small>
						Flexbox can do some pretty awesome things when you mix flex alignments with auto margins. Shown below are three examples of controlling flex items via auto margins: default (no auto margin), pushing two items to the right (<code>.mr-auto</code>)");
            WriteLiteral(@", and pushing two items to the left (<code>.ml-auto</code>).
					</small>
				</h4>
				<p>
            ...
            WriteLiteral(@" bd-highlight"">Flex item</div>
					</div>
				</div>
			</div>
		</div>	
		<div class=""card mb-g"">
			<div class=""card-body"">
				...
				<div class=""frame-wrap"">
					...
					<div class=""d-flex align-items-end flex-column b");
            WriteLiteral(@"d-highlight mb-3"" style=""height: 200px;"">
					  <div class=""p-2 bd-highlight"">Flex item</div>
					  <div class=""p-2 bd-highlight"">Flex item</div>
			...
			<div class=""card-body"">
				...
				<div class=""frame-wrap"">
					<div class=""d-flex flex-nowrap bd-highlight"" style=""width: 8rem;"">
						...
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div cla");
            WriteLiteral(@"ss=""p-2 bd-highlight"">Flex item</div>
					</div>
				</div>
				<h5 class=""frame-heading"">
					d-flex flex-wrap
				...
				<div class=""frame-wrap"">
					<div class=""d-flex flex-wrap bd-highlight"">
						...
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p");
            WriteLiteral(@"-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
		...
		<div class=""card mb-g"">
			<div class=""card-body"">
				<h4 class=""mb-g"">
					...
					<small>
						Use <code>align-content</code> utilities on flexbox containers to align flex items <em>together</em> on the cross axis. Choose from <code>start</code> (browser defaul");
            WriteLiteral(@"t), <code>end</code>, <code>center</code>, <code>between</code>, <code>around</code>, or <code>stretch</code>. To demonstrate these utilities, we’ve enforced <code>flex-wrap: wrap</code> and increased the number of flex items.
					</small>
				</h4>
				...
				<div class=""frame-wrap"">
					<div class=""d-flex align-content-start flex-wrap bd-highlight mb-3"" style=""height: 200px"">
						...
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlig");
            WriteLiteral(@"ht"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
				...
				<div class=""frame-wrap"">
					<div class=""d-flex align-content-center flex-wrap bd-highlight mb-3"" style=""height: 200px"">
						...
						<div class=""p-2 bd-highlight"">Flex item</div>
						<di");
            WriteLiteral(@"v class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
						<div class=""p-2 bd-highlight"">Flex item</div>
